module.exports = {
	...
	rules: {
		...
		// A component with two `methods:` (or `computed:`, `data:`, ...) blocks loses
		// the first one silently — JavaScript keeps the last key. This project does not
		// extend eslint:recommended, so the rule has to be listed explicitly.
		"no-dupe-keys": "error",
