...
const character_getters = {
	...
	character_count: (state) => {
		return state.character_count;
	},
	computed_characters: (state) => {
		return state.computed_characters;
	},
	...
	character_services: (state) => {
		return state.character_services;
	},
};
...
const character_mutations = {
	SET_CHARACTER_SERVICES(state, payload) {
		state.character_services = payload;
	},
	SET_CHARACTERS(state, payload) {
		state.characters = payload;
	},
	SET_CHARACTER_COUNT(state, value) {
