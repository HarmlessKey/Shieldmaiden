...
const HkShowKeybind = defineAsyncComponent(
	() => import("../components/hk-components/hk-show-keybind")
);
const HkRoll = defineAsyncComponent(() => import("../components/hk-components/hk-roll"));
const HkRollAction = defineAsyncComponent(
	() => import("../components/hk-components/hk-action-rolls/hk-roll-action")
);
const HkAnimatedInteger = defineAsyncComponent(
	() => import("../components/hk-components/hk-animated-integer")
);
...
const HkDmgTypeSelect = defineAsyncComponent(
	() => import("../components/hk-components/hk-dmg-type-select")
);
...
const HkShare = defineAsyncComponent(
	() => import("../components/hk-components/hk-share-button")
);
const HkImageUploader = defineAsyncComponent(
	() => import("../components/hk-components/hk-image-uploader")
);
const HkBackgroundSelect = defineAsyncComponent(
	() => import("../components/hk-components/hk-background-select")
);
const HkMarkdownEditor = defineAsyncComponent(
	() => import("../components/hk-components/hk-markdown-editor")
);
const HkXpBar = defineAsyncComponent(() => import("../components/hk-components/hk-xp-bar"));
const HkLinkCharacter = defineAsyncComponent(
	() => import("../components/hk-components/hk-link-character")
);
...
const HkTransformSelect = defineAsyncComponent(
	() => import("../components/hk-components/hk-transform-select")
);
