<template>
	<div>
		...
		<div v-if="loading" class="loader"> <span>Loading old_spell....</span></div>
			<b-row>
				<b-col md="4" id="old_spell">
					<b-card header="Old Spell Description">
