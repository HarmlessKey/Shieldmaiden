...
export default function ({ store, ssrContext }) {
  ...
  // Check before each page load whether the page requires authentication/
	...
	// 		const currentUser = store.getters.user; //Check if there is a user
	...
	// 		console.log("beforeEach: current user", currentUser)

	// 		if(to.path === "/sign-in" && currentUser) {
	...
	// 				console.log('user info from beforeeach')
