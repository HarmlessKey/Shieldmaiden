<template>
	<hk-card>
		<div slot="header" class="card-header">
			Get support
			<a class="btn btn-sm bg-discord-purple" href="https://discord.gg/ZHDGj6GqJH" target="_blank">
		...
		<q-no-ssr class="card-body">
			<p>
				...
				We recommend joining our <a href="https://discord.gg/ZHDGj6GqJH" target="_blank">Discord server</a>, 
