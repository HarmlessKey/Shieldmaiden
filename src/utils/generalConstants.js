...
/**
 * Every valid monster challenge rating, ascending.
 * CRs are not evenly spaced, so a range between two CRs can only be resolved
 * by slicing this list — never by counting up from the lower bound.
 */
...
/** Display labels for the fractional challenge ratings */
export const challenge_rating_labels = Object.freeze({
	0.125: "1/8",
	0.25: "1/4",
	0.5: "1/2",
});
