			...
			<section id="run-encounter">
				...
				<h3>Setting initiatve</h3>
					...
					<p>In the view of setting the initative, players and NPC's alike can be set to either <u>idle</u> or <u>active</u>. 
						...
						you can allready add them to the encounter, but just set them to idle. Check the section on tracking initiative to see how we handle adding entities during an encounter.</p>

					<h3 class="mt-5">Tracking initiative</h3>
					...
					<p>
						...
						As soon as the new round starts, all the tagged entities will be added to active list and a new order is calculated for this round.
					</p>

					<h3 class="mt-5">Manual damage and healing</h3>
					...
					<p>
						...
						When the healing higher than the target's maximum hit points, the current hit points will be set to equal the maximum. 
					...
					<p>
						...
						If a player that is down or stabilized receives damage, they fail one death save (two if it is a critical hit).<br/>
					...
					<p><b>Temporary Hit Points.</b> During an encounter entities can be given temporary hit points through the edit function. 
						Temporary hit points are handled as the rulebook describes. They serve as an extra pool for damage, but healing will not be put in the temporary pool.
					...
					<p><b>Transformed targets.</b> If a target is transformed, like a druid in Wild Shape, they get new hit points and a new armor class. 
						The new hit points are handled as the rulebook describes for Wild Shape and Polymorph. Damage and healing will be done in the new health pool, 
