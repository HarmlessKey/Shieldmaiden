<template>
	<div v-if="!loading">
		...
		<div v-else-if="character.build === 'advanced'" class="row q-col-gutter-md content__edit">
			<div class="col-12" :class="{ 'col-md-9': width > 978 }">
				<div class="tabs">
					<q-tabs dark inline-label align="left" no-caps>
						<q-route-tab
...
export default {
	...
	methods: {
		...mapActions("characters", ["get_character", "update_character"]),
		setSize(size) {
