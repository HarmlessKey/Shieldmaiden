						...
						<q-td auto-width>
							<div class="d-flex justify-right">
								<a class="btn btn-sm bg-neutral-5 mr-2" @click="editVoucher(props.row)">
									...
									<q-tooltip anchor="top middle" self="center middle"> Edit voucher </q-tooltip>
								</a>
								<template>
									<a
										v-if="!props.row.disabled"
										class="btn btn-sm bg-neutral-5 mr-2"
										@click="disableVoucher(props.row.voucher)"
									>
									...
									<a
										v-else
										class="btn btn-sm bg-neutral-5 mr-2"
										@click="enableVoucher(props.row.voucher)"
									>
										<i class="fas fa-check-square" aria-hidden="true" />
										<q-tooltip anchor="top middle" self="center middle"> Enable voucher </q-tooltip>
									</a>
								</template>
								<a class="btn btn-sm bg-neutral-5" @click="deleteVoucher(props.row.voucher)">
									<i class="fas fa-trash-alt" aria-hidden="true" />
									<q-tooltip anchor="top middle" self="center middle"> Delete voucher </q-tooltip>
								</a>
							</div>
						</q-td>
					</q-tr>
