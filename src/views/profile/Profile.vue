					...
					<div class="card-body">
						...
						<div class="actions">
							...
							<div class="d-flex justify-content-between">
								<a @click="resetPassword()" class="neutral-3"><i class="fas fa-redo-alt blue"></i> Reset Password</a>
								<router-link to="/profile/delete-account" class="neutral-3"><i class="fas fa-trash-alt red"></i> Delete account</router-link>
							</div>
						</div>
					</div>
				</hk-card>
