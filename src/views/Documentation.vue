			...
			<div>
				<section id="campaigns">
					<b-card header="Campaigns">
						...
						<p><b>Why do I have to add players to my campaigns?</b><br/>
						We keep track of all sorts of information of a player under the campaign. Below is a list of everything that is saved under the campaign. Removing a player from the campaign will result in a reset of all this info.</p>
				...
				<section id="encounters">
					<b-card header="Encounters">
						...
						<p><b>Background</b><br/>
							A background image can be added to an encounter, this image is shown on the background (if you choose so) when you run the encounter. It is also shown on the background of the track encounter screen where your players can follow your active encounter. It is mainly for this purpose we added the option of adding a background. It can really give some atmosphere to your encounters.
						</p>

						<p><b>Loot</b><br/>
							Loot is nothing more than a reminder that shows when you finish an encounter. You probably have thought of some loot your players might find if they manage to defeat your encounter. This will give you a simple overview when the encounter has ended. 
				...
				<section id="run-encounter">
					...
					<h2 id="run-encounter-set-in" class="pt-5">Setting initiatve</h2>
						...
						<p>When rolling for an NPC, we add their dexterity modifier to the roll. When rolling some NPC's as a group, we use the lowest dexterity as the modifier.</p>

						<p>In the view of setting the initiative, players and NPC's alike can be set to either idle or active. The idle entities will not enter the encounter until you want them to. This way you can create an encounter with waves of monsters and add these waves whenever you want. Or maybe you have a monster that can summon some sort of entity, you can already add these to the encounter, but just set them to idle.
						...
						<p>
							When the current entity is an NPC, you can choose to roll the attacks automatically. A d20 plus their to hit modifier and the damage of the attack will be rolled at the same time. A notification will pop up showing you the results of the roll and asking you if and how you want to apply the damage. If you count it as a hit, the damage is handled exactly the same as manual damage. You can also choose to either double or half the damage. When halved, the outcome is rounded down.<br/>
