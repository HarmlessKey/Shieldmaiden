		...
		return {
			...
			effect_subtypes: {
				...
				special: {
					...
					max_damage: { label: "Maximum Damage", value: "max_damage", form_fields: { damage_types: true } },
					death_ward: { label: "Death Ward", value: "death_ward" },
					description: { label: "Description", value: "description", form_fields: { description: true } },
				},
				// description: {}
			}
		}
