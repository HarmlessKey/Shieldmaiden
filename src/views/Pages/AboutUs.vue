		...
		<hk-card>
			...
			<div class="card-body">
				<p>
					...
					stressful. Shieldmaiden (formerly known as Harmless Key) stream lines combat leaving you
					with more time to focus on the story you want to tell with an encounter.<br />
					Shieldmaiden makes combat a breeze by keeping track of everything a DM needs during
					combat, from hit points, initiative and AC, to concentration checks, conditions and
					surprise rounds. Making combat faster, more accurate and hassle-free.
				</p>
				<p>
					Shieldmaiden is created by two experienced Dungeons & Dragons players from Amsterdam. We
					were missing an encounter tracker that tended to all our needs, so we decided to build one
					ourselves.<br />
					After some positive feedback from our fellow D&D players, we decided to share it with the
					public in February 2019.<br />
					Since then we've been improving and expending a lot and this is still going on.
				</p>
				<h3 class="mb-0">We hope you get as much use out of Shieldmaiden as we do.</h3>
			</div>
		</hk-card>
				...
				<div class="card-body sheet">
					<div class="character harm">
						<div class="d-flex justify-content-start items-center">
							<div
								class="img"
								:style="{ 'background-image': 'url(' + require('src/assets/_img/harm.jpg') + ')' }"
							></div>
							<div>
								Harm Manders<br />
								<small
									><i aria-hidden="true" class="neutral-3">Male human developer</i><br />
								...
								>
									<li>
										<span class="skill">
											<i
												aria-hidden="true"
												:class="proficient ? 'fas' : 'far'"
												class="fa-circle mr-1"
											/>
											{{ skill }}
										</span>
										<span class="score">
				...
				<div class="card-body sheet">
					<div class="character key">
						<div class="d-flex justify-content-start items-center">
							<div
								class="img"
								:style="{ 'background-image': 'url(' + require('src/assets/_img/key.jpg') + ')' }"
							></div>
							<div>
								Key Roos<br />
								<small
					...
					<div class="row q-col-gutter-md">
						<div class="col">
							...
							<ul class="abillities">
								...
								<li>CSS <span class="score">19</span></li>
